...
function App() {
  ...
  const won = (winner) => {
    ...
    if (winner === 'x')
      {
        titleRef.current.innerHTML = `Congratulations: <img src=${cross_icon}> has won`;
      }
      else 
      {
        titleRef.current.innerHTML = `Congratulations: <img src=${circle_icon}> has won`;
      }
  }
  ...
  return (
    <div className="container">
      <h1 className="gameTopic" ref={titleRef}>TicTacToe</h1>
      <div className="board">
        <div className="row1">
          <div
